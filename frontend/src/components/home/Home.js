      ...
      <div className="d-flex flex-wrap align-items-center px-4">
        ...
        <div className="align-items-center gap-2 flex-wrap">
         ...
         <FaMapMarkerAlt className="text-primary mt-3 "/>
          <button className="btn btn-purple mt-3 ms-3">Find Company</button>
          <button className="btn btn-purple mt-3 ps-3" onClick={() => setShowModal(true)} style={{marginLeft:'120px'}}>+ Add Company</button>
